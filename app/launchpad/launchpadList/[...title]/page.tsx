...
export default function page({ params }: { params: { title: string } }) {
  return (
    <section className="text-white pt-6 pb-20 pl-[2.37rem] pr-20 xl:border-t xl:border-[#424242]">
      ...
      <div className="grid lg:grid-cols-2 gap-[1.87rem]">
        ...
        <section className="flex flex-col gap-6 text-white">
          ...
          <div className="bg-[#1D1C20] pt-[1.13rem] border border-[#3F3F46] rounded-[0.65rem] px-5 py-4">
            {/* PROGRESS */}
            <div className="">
