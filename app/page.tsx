  ...
  return (
    <section className="mt-5 pl-[1.69rem] pr-20">
      ...
      <div className="mt-8 text-white">
        <h1 className=" text-[2.5rem] tracking-[-0.075rem] leading-[3.375rem]">
          The{" "}
        ...
        <p className="text-[#D1D1D6] mb-8 tracking-[-0.01125rem] text-[1.125rem]">
        ...
        <div className="">
          <button className="mr-8 rounded-[0.625rem] py-[1.3125rem] px-[2.4375rem] bg-[#454FDA] text-white">
            Create new
          </button>
