...
export default function Home() {
  return (
    <div className="pt-[2.69rem] mt-5 mb-20 pl-[1.06rem] w-fit overflow-x-hidden">
      {/* border-t border-[#424242] */}
      <LatestPools />

      <div className="mt-10 text-white text-center lg:text-left pr-[1.06rem] md:pr-16">
      ...
      {/* ------------------------------ */}
      {/* CARDS */}
      <div className="mt-[3.69rem] mb-[5.19rem] mr-[1.06rem] w-fit flex flex-wrap gap-[0.88rem]">
        {/* TOTAL LIQUIDITY RAISED */}
        <section className="w-full text-center lg:text-left md:w-fit md:min-w-[12rem] bg-gradient-to-b from-[#51525c] to-[#28282a] p-0.5 rounded-[0.62rem]">
      ...
      <TrendingPools />
      <div className="mt-[3.12rem] grid md:grid-cols-2 gap-12 sm:gap-8 mr-[1.06rem]">
        <HotAirdrops />
        <NewTokens />
      </div>
    </div>
