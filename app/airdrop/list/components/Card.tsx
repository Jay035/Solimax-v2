...
export function Card({ item }: any) {
  ...
  return (
    <article className="bg-[#1d1c20] border border-[#70707a] w-full rounded-[0.72294rem] p-[1.74rem] pb-[1.69rem] pr-[1.53rem]">
      <header className="mb-[1.45rem] flex items-center gap-12 justify-between">
        ...
        <div className="flex items-center gap-2 text-white">
          ...
          {/* <div className="bg-gradient-to-r p-0.5 rounded-[0.72294rem] from-[#81c8f2] via-[#acd44d] to-[#d9d9d9]"> */}
            <p className="p-[0.72294rem] rounded-[0.72294rem] bg-[#a4d0f28c]/[0.05] border border-[#81C8F2]">
              {item?.status}
            </p>
          {/* </div> */}
        </div>
