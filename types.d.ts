...
interface FormProps {
	...
	showModal?: boolean;
	modalHeader?: string;
	bridgeDestinationChain?: string;
	bridgeDestinationLogo?: string;
	bridgeSourceChain?: string;
	bridgeSourceChains?: any;
	bridgeSourceChainId?: any;
	setBridgeSourceChainId?: (x: number) => any;
	...
	setBridgeSourceLogo?: (x: string) => void;
	setBridgeSourceChain?: (x: string) => void;
	setBridgeSourceChains?: (x: any) => void;
	destinationChainOptions?: any;
	sourceChainOptions?: any;
