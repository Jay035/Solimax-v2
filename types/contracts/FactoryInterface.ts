...
export interface FactoryInterfaceInterface extends Interface {
  getFunction(
...
export interface FactoryInterface extends BaseContract {
  connect(runner?: ContractRunner | null): FactoryInterface;
